...
Data = '../Data'
modelname = 'VisionTransformerGrey.pth'
...
# model = Model()
# model.load_state_dict(torch.load("../Model/"+modelname,map_location=torch.device('cuda')))
...
try:
  ...
  def test_accuracy_f1(test_dl):
    ...
    for num,(img,label) in tqdm(enumerate(test_dl)):
